...
def rem(inputfile,outfile):
    ...
    for line in filehandle:
        ...
        if values[SRC_COL_IDX] == '1' and values[ADMIT_YEAR_IDX] == '2013':
            patient = values[32]
            patient_ids.add(patient)

    print("Number of patients in 2013 "+str(len(patient_ids)))
    filehandle.close()
    ...
    print visit_dist_2013,  visit_dist_2011

rem('/Users/oshpddata/Desktop/OSHPD2016/OSHPD_ALLCAUSE.csv','/Users/oshpddata/Desktop/vikhyati/2013_ED_BACKWARD.csv' )
